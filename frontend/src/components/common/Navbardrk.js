  ...
  render(){
    return (
      ...
      <nav className="navbar navbar-drk">
        ...
        <div className={`navbar-end navbar-menu ${this.state.isOpen ? 'is-active is-active-dark' : ''}`}>
          ...
          <Link to="/contact" className="navbar-item navbar-end navbar-space">Contact</Link>
        </div>
      </nav>
