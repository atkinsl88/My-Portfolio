    ...
    <div className="hero-lrg-container">
      ...
      <div className="hero-lrg-lft">
        <div className="hero-txt-lft">
          <p>Digital deisgn and development has always been a passion of mine, in 2020 I decided to transition from Digital Project Manager to Software Engineer. I've since worked on private projects on a freelance basis.</p>
        </div>
